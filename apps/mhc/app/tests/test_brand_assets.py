...
class TestEmailBrand:
    ...
    def test_inscription_approval_email_uses_brand_teal(self, mock_send_email: MagicMock, test_user):
        mock_send_email.delay = MagicMock()

        UserService.send_inscription_approval_email(test_user)
    ...
    @patch("app.services.user_service.send_email")
    def test_inscription_approval_email_contains_activation_link(self, mock_send_email: MagicMock, test_user):
        mock_send_email.delay = MagicMock()
