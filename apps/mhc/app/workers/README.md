...
# Push Notifications (FCM — HTTP v1 recommandé)
FCM_SERVICE_ACCOUNT_PATH=/chemin/vers/firebase-adminsdk-xxxxx.json
# ou : GOOGLE_APPLICATION_CREDENTIALS=/meme/chemin.json
# Ancienne clé serveur (si encore disponible) :
# FCM_SERVER_KEY=
