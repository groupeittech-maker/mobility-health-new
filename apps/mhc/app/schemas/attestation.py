...
class AttestationReviewItem(BaseModel):
    ...
    numero_attestation: str
    attestation_download_url: Optional[str] = None
    attestation_created_at: datetime
    souscription_id: int
    numero_souscription: str
    souscription_status: str
    prix_applique: Optional[float] = None
    currency: Optional[str] = None  # Devise du produit (ex. XAF)
    date_debut: Optional[datetime] = None
    date_fin: Optional[datetime] = None
    travel_destination_city: Optional[str] = None
    travel_destination_country: Optional[str] = None
    ...
    medical_validation_reviewer_name: Optional[str] = None
