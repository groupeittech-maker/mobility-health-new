        ...
        products.forEach(product => {
            html += `
                <div class="product-card">
                    ...
                    <div class="product-price">${formatMontantDevis(product.cout, product.currency)}</div>
                    ${product.garanties ? (() => {
                        let garantiesList = [];
                        try {
...
function setupCalculator() {
    ...
    form.addEventListener('submit', async function(e) {
        ...
        document.getElementById('estimated-price').textContent = formatMontantDevis(estimatedPrice, 'XAF');
