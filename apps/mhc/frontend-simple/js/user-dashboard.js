        ...
        loadingEl.innerHTML = `
            <div class="alert alert-error">
                ...
                ${isConnectionError ? `
                    ...
                    <p>Vérifiez que l'API est accessible sur https://api.srv1324425.hstgr.cloud</p>
                ` : ''}
            ...
            <div class="subscription-card">
                ...
                <div class="subscription-info">
                    ...
                    <div class="subscription-info-item">
                        ...
                        <span class="subscription-info-value">${formatMontantDevis(subscription.prix_applique, subscription.produit_assurance && subscription.produit_assurance.currency)}</span>
                    </div>
                </div>
