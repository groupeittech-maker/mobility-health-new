        ...
        try {
            ...
            container.innerHTML = `
                <div class="alert alert-error">
                    ...
                    <ul>
                        <li>Le serveur backend est-il accessible sur https://api.srv1324425.hstgr.cloud ?</li>
        ...
        container.innerHTML = `
            <div class="alert alert-error">
                ...
                ${isConnectionError ? `
                    ...
                    <p>Vérifiez que le backend est accessible sur https://api.srv1324425.hstgr.cloud</p>
