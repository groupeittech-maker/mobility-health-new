  ...
  Future<void> _submit(bool approve) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(approve ? 'Validation médicale enregistrée.' : 'Facture refusée.'),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          Text('Montant HT : ${inv['montant_ht']} €'),
          Text('TVA : ${inv['montant_tva']} €'),
          Text('TTC : ${inv['montant_ttc']} €', style: const TextStyle(fontWeight: FontWeight.w600)),
          const SizedBox(height: 8),
            ...
            ...items.map<Widget>((raw) {
              ...
              return Card(
                ...
                child: ListTile(
                  ...
                  subtitle: Text(
                    'Qté ${line['quantite']} × ${line['prix_unitaire']} € HT → ${line['montant_ttc']} € TTC',
                  ),
                ),
              );
            })
